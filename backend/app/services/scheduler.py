...
# Recordatorios push: cada 4 h en punto (hora local). El propio job descarta
# las ejecuciones fuera del horario activo 08–22 (push.ACTIVE_FROM/UNTIL), así
# que en la práctica envía a las 08/12/16/20 como mucho, y solo a quien tenga
# algo pendiente. El resumen del COACH usa la misma cadencia.
PUSH_EVERY_HOURS = 4
